...
| Field of view | 80 mas @ f/8 | Optimal injection efficiency is for a focal ratio of 8, <br>
providing a field of view of 80 mas.The field of view is defined as the area where the <br>
injection efficiency drops to 50% compared to the center of the field. |
